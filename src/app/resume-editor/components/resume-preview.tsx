...
const ResumePreview = ({
  ...
  return (
    ...
    //
    // 56px is the nav, 44px the language tabs beside this (`h-11` in
    // language-switcher.tsx): the desk starts where the document's tabs end, so
    // their rules meet rather than missing each other by a dozen pixels.
    <div className="sticky top-[calc(56px+44px)] h-[calc(100vh-56px-44px)] w-1/2 border-l bg-muted/40">
