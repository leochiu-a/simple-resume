...
/**
 * A project has no timeline, so the right of the headline row is where its url
 * goes instead of a date range — the same line, doing the same job of saying
 * where the thing can be found. Then the description as disc bullets, same as
 * Experience.
 *
