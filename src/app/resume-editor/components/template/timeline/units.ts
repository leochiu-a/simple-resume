...
/**
 * Slightly under A4's 841.89pt so the sheet stays one page. It also gives the
 * columns a height to stretch into — the footer rule has to sit at the bottom of
 * the sheet, and in the preview the page has no intrinsic height of its own.
 */
