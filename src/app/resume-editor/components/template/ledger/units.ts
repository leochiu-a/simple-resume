...
/**
 * The label gutter's share of the text column, as a percentage string.
 *
 * The two renderers have to agree on this number or the labels and their content
 * drift apart between the preview and the PDF, so it is defined once here and
 * both `styles.ts` and the HTML builder read it.
 */
